	...
	switch(event.body){
		case "1":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/rat.png`)
		...
		case "2":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/suu.png`)
			}, event.threadID, event.messageID);
			break;
		case "3":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/dan.png`)
			}, event.threadID, event.messageID); 
			break;
		case "4":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/mao.png`)
			}, event.threadID, event.messageID); 
			break;
		case "5":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/rong.png`)
			}, event.threadID, event.messageID); 
			break;
		case "6":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/ran.png`)
			}, event.threadID, event.messageID); 
			break;
		case "7":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/ngua.png`)
			}, event.threadID, event.messageID); 
			break;
		case "8":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/mui.png`)
			}, event.threadID, event.messageID); 
			break;
		case "9":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/khi.png`)
			}, event.threadID, event.messageID); 
			break;
		case "10":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/ga.png`)
			}, event.threadID, event.messageID); 
			break;
		case "11":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/cho.png`)
			}, event.threadID, event.messageID); 
			break;
		case "12":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/heo.png`)
			}, event.threadID, event.messageID); 
			break;
		default:
	}
